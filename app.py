"""
Free Fire Bot API - Flask Version
Deploy on Render
Endpoints:
...
<body>
    <h1>🎮 Free Fire Bot API v13.0 (Flask)</h1>
    <p>Status: <span class="status">✅ Online</span> | Active Bots: {{ bot_count }}</p>
...
def home():
    ...
    return render_template_string(HTML_TEMPLATE, bot_count=len(active_bots))
